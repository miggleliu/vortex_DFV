...
#define VX_CSR_DFV_SET_THRESHOLD   0x7C3 // SET probability (32-bit): stall activates when lfsr1[31:0] < threshold // Stall probability (0-255): stall when lfsr[7:0] < threshold
